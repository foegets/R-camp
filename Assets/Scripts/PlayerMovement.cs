...
{   
    ...
    {   
        ...
        RaycastHit2D wallCheck = Raycast(new Vector2(footOffset / 2 * direction, eyeHeight), grabDir, grabDistance, groundLarer);
        RaycastHit2D ledgeCheck = Raycast(new Vector2(reachOffset * direction, playerHeight),Vector2.down,grabDistance,groundLarer);
